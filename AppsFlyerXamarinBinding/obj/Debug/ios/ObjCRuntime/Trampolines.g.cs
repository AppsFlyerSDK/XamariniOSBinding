	...
	static partial class Trampolines {
		...
		static internal class SDActionArity1V0 {
			...
			static unsafe void Invoke (IntPtr block, IntPtr obj) {
				...
				var del = (global::System.Action<NSDictionary>) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<Foundation.NSDictionary> (obj));
			}
		...
		static internal class SDActionArity2V0 {
			...
			static unsafe void Invoke (IntPtr block, IntPtr arg1, IntPtr arg2) {
				var descriptor = (BlockLiteral *) block;
				var del = (global::System.Action<NSError, NSObject>) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<Foundation.NSError> (arg1),  Runtime.GetNSObject<Foundation.NSObject> (arg2));
			}
		...
		internal class NIDActionArity2V0 {
			...
			[Preserve (Conditional=true)]
			public unsafe static global::System.Action<NSError, NSObject> Create (IntPtr block)
			{
				return new NIDActionArity2V0 ((BlockLiteral *) block).Invoke;
			}
			
			[Preserve (Conditional=true)]
			unsafe void Invoke (NSError arg1, NSObject arg2)
			{
